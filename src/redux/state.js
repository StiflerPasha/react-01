...
let state = {
    sideBar: {
        ...
        friends: [
            {id: "1", name: "Andrey", ava: ava_png},
            {id: "2", name: "Sasha", ava: ava_png},
            {id: "3", name: "Kate", ava: ava_png},
        ],
    },
    profilePage: {
        posts: [
    ...
    dialogsPage: {
        dialogs: [
            {id: "1", name: "Pasha", ava: ava_png},
            {id: "2", name: "Andrey", ava: ava_png},
            {id: "3", name: "John", ava: ava_png},
            {id: "4", name: "Sasha", ava: ava_png},
            {id: "5", name: "Smith", ava: ava_png},
            {id: "6", name: "Valera", ava: ava_png},
        ],
        messages: [
            {id: "1", msg: "Hi"},
